...
var Simplemde = /** @class */ (function (_super) {
    ...
    Simplemde = __decorate([ __param(0, Inject(SIMPLEMDE_CONFIG)),
        __metadata("design:paramtypes", [Object])
    ], Simplemde);
Simplemde.ɵfac = function Simplemde_Factory(t) { return new (t || Simplemde)(ɵngcc0.ɵɵdirectiveInject(SIMPLEMDE_CONFIG)); };
Simplemde.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Simplemde, selectors: [["simplemde"]], viewQuery: function Simplemde_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 5);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.textarea = _t.first);
    } }, inputs: { options: "options", codemirror: "codemirror" }, features: [ɵngcc0.ɵɵProvidersFeature([
            SIMPLEMDE_CONTROL_VALUE_ACCESSOR
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 2, vars: 0, consts: [["simplemde", ""]], template: function Simplemde_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "textarea", null, 0);
    } }, encapsulation: 2 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(Simplemde, [{
        type: Component,
        args: [{
                selector: 'simplemde',
...
SimplemdeModule.ɵfac = function SimplemdeModule_Factory(t) { return new (t || SimplemdeModule)(); };
SimplemdeModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: SimplemdeModule });
SimplemdeModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            FormsModule,
            CommonModule
        ], FormsModule,
        CommonModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SimplemdeModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    Simplemde
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SimplemdeModule, { declarations: function () { return [Simplemde]; }, imports: function () { return [FormsModule,
        CommonModule]; }, exports: function () { return [Simplemde, FormsModule,
        CommonModule]; } }); })();
