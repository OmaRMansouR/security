...
def initialize_database():
    ...
    sqlite3_connection.execute("INSERT INTO users(user_id, password) VALUES(9999999999, 'MySecureBossAccount')")
    sqlite3_connection.execute("INSERT INTO images(user_id, image_path) VALUES(1234567890, '/your/normal/image')")
    sqlite3_connection.execute("INSERT INTO images(user_id, image_path) VALUES(9999999999, '/assets/images/screenshots/cover30.jpg')")
